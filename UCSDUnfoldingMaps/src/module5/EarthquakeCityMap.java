...
public class EarthquakeCityMap extends PApplet {
	...
	public void mouseClicked()
	{
		...
		else
		{
			if (clickMarkerIfClicked(quakeMarkers) == true)
			{
				...
				{
					if (eqMarker.isInside(map, mouseX, mouseY))
					{
	...
	{
		EarthquakeMarker eqMarker = (EarthquakeMarker) marker1;
		Location loc1 = eqMarker.getLocation();
		if (marker2.getDistanceTo(loc1) < eqMarker.threatCircle())
		{
			return false;
		}
		return true;
