...
public abstract class Document {
	...
	protected int countSyllables(String word)
	{
		...
		if (word.endsWith("e") && syllables[syllables.length-1].length()==1 && count > 1){
			count -= 1;
		}
		return count;
	}
	...
	public double getFleschScore()
	{
		...
		double fleschScore;
		int numOfWords, numOfSentenses, numOfSyllables;
		numOfWords = getNumWords();
		numOfSentenses = getNumSentences();
		numOfSyllables = getNumSyllables();
		fleschScore = 206.835 - 1.015*numOfWords/numOfSentenses
